(function () {
  ...
  async function loadData() {
    showSplashSpinner();
    showSkeletons();
    try { await loadStatic(); } catch (e) { console.warn(e); throw e; }
  }
    ...
    try {
      ...
      if (staticLoaded && state.static && state.static.length > 500) {
        for (var i = 0; i < state.static.length; i++) {
          ...
          if (d <= max) {
            var ud = null;
            if (state.userLat != null && state.userLng != null) ud = haversine(state.userLat, state.userLng, t.lat, t.lng);
            items.push({
        ...
        for (var j = 0; j < live.length; j++) {
          ...
          if (d2 <= max) {
            t2.dist = d2;
            t2.userDist = (state.userLat != null && state.userLng != null) ? haversine(state.userLat, state.userLng, t2.lat, t2.lng) : null;
            items.push(t2);
          }
        }
  ...
  var UK_PLACES = [
    {n:'London',lat:51.5074,lon:-0.1278},{n:'Birmingham',lat:52.4862,lon:-1.8904},
    {n:'Manchester',lat:53.4808,lon:-2.2426},{n:'Leeds',lat:53.8008,lon:-1.5491},
    {n:'Glasgow',lat:55.8642,lon:-4.2518},{n:'Edinburgh',lat:55.9533,lon:-3.1883},
    {n:'Liverpool',lat:53.4084,lon:-2.9916},{n:'Bristol',lat:51.4545,lon:-2.5879},
    {n:'Sheffield',lat:53.3811,lon:-1.4701},{n:'Newcastle upon Tyne',lat:54.9783,lon:-1.6178},
    {n:'Nottingham',lat:52.9548,lon:-1.1581},{n:'Cardiff',lat:51.4816,lon:-3.1791},
    {n:'Belfast',lat:54.5973,lon:-5.9301},{n:'Leicester',lat:52.6369,lon:-1.1398},
    {n:'Coventry',lat:52.4068,lon:-1.5197},{n:'Bradford',lat:53.7960,lon:-1.7594},
    {n:'Stoke-on-Trent',lat:53.0027,lon:-2.1794},{n:'Wolverhampton',lat:52.5862,lon:-2.1288},
    {n:'Plymouth',lat:50.3755,lon:-4.1427},{n:'Derby',lat:52.9225,lon:-1.4746},
    {n:'Southampton',lat:50.9097,lon:-1.4044},{n:'Portsmouth',lat:50.8198,lon:-1.0880},
    {n:'Reading',lat:51.4543,lon:-0.9781},{n:'Northampton',lat:52.2405,lon:-0.9027},
    {n:'Luton',lat:51.8787,lon:-0.4200},{n:'Bolton',lat:53.5769,lon:-2.4282},
    {n:'Bournemouth',lat:50.7192,lon:-1.8808},{n:'Norwich',lat:52.6309,lon:1.2974},
    {n:'Swindon',lat:51.5558,lon:-1.7797},{n:'Swansea',lat:51.6214,lon:-3.9436},
    {n:'Southend-on-Sea',lat:51.5459,lon:0.7077},{n:'Middlesbrough',lat:54.5742,lon:-1.2350},
    {n:'Peterborough',lat:52.5695,lon:-0.2405},{n:'Cambridge',lat:52.2053,lon:0.1218},
    {n:'Oxford',lat:51.7520,lon:-1.2577},{n:'Ipswich',lat:52.0567,lon:1.1482},
    {n:'Blackpool',lat:53.8175,lon:-3.0357},{n:'York',lat:53.9591,lon:-1.0815},
    {n:'Slough',lat:51.5105,lon:-0.5950},{n:'Basildon',lat:51.5724,lon:0.4701},
    {n:'Basingstoke',lat:51.2667,lon:-1.0833},{n:'Warrington',lat:53.3900,lon:-2.5970},
    {n:'Huddersfield',lat:53.6458,lon:-1.7850},{n:'Exeter',lat:50.7184,lon:-3.5339},
    {n:'Gloucester',lat:51.8642,lon:-2.2382},{n:'Sunderland',lat:54.9069,lon:-1.3838},
    {n:'Brighton',lat:50.8225,lon:-0.1372},{n:'Hove',lat:50.8279,lon:-0.1687},
    {n:'Milton Keynes',lat:52.0406,lon:-0.7594},{n:'Aberdeen',lat:57.1497,lon:-2.0943},
    {n:'Dundee',lat:56.4620,lon:-2.9707},{n:'Inverness',lat:57.4778,lon:-4.2247},
    {n:'Bath',lat:51.3811,lon:-2.3590},{n:'Canterbury',lat:51.2802,lon:1.0789},
    {n:'Chester',lat:53.1934,lon:-2.8931},{n:'Durham',lat:54.7761,lon:-1.5733},
    {n:'Lancaster',lat:54.0466,lon:-2.8007},{n:'Lincoln',lat:53.2307,lon:-0.5406},
    {n:'Salisbury',lat:51.0688,lon:-1.7945},{n:'Winchester',lat:51.0632,lon:-1.3080},
    {n:'Worcester',lat:52.1936,lon:-2.2215},{n:'Carlisle',lat:54.8951,lon:-2.9382},
    {n:'Truro',lat:50.2632,lon:-5.0510},{n:'Newport',lat:51.5842,lon:-2.9977},
    {n:'Wrexham',lat:53.0430,lon:-2.9925},{n:'Bangor',lat:53.2274,lon:-4.1293},
    {n:'Stirling',lat:56.1165,lon:-3.9369},{n:'Perth',lat:56.3950,lon:-3.4308},
    {n:'Hull',lat:53.7676,lon:-0.3274},{n:'Kingston upon Hull',lat:53.7676,lon:-0.3274},
    {n:'Doncaster',lat:53.5228,lon:-1.1285},{n:'Rotherham',lat:53.4326,lon:-1.3635},
    {n:'Barnsley',lat:53.5526,lon:-1.4797},{n:'Wakefield',lat:53.6833,lon:-1.4977},
    {n:'Halifax',lat:53.7270,lon:-1.8575},{n:'Preston',lat:53.7632,lon:-2.7031},
    {n:'Blackburn',lat:53.7486,lon:-2.4870},{n:'Burnley',lat:53.7893,lon:-2.2405},
    {n:'Oldham',lat:53.5409,lon:-2.1114},{n:'Rochdale',lat:53.6097,lon:-2.1561},
    {n:'Stockport',lat:53.4106,lon:-2.1575},{n:'Wigan',lat:53.5450,lon:-2.6325},
    {n:'Salford',lat:53.4875,lon:-2.2901},{n:'Telford',lat:52.6784,lon:-2.4453},
    {n:'Shrewsbury',lat:52.7073,lon:-2.7553},{n:'Hereford',lat:52.0565,lon:-2.7160},
    {n:'Cheltenham',lat:51.8994,lon:-2.0783},{n:'Taunton',lat:51.0148,lon:-3.1030},
    {n:'Torquay',lat:50.4619,lon:-3.5253},{n:'Newquay',lat:50.4120,lon:-5.0757},
    {n:'Maidstone',lat:51.2704,lon:0.5227},{n:'Dover',lat:51.1279,lon:1.3134},
    {n:'Colchester',lat:51.8959,lon:0.9035},{n:'Chelmsford',lat:51.7356,lon:0.4685},
    {n:'Watford',lat:51.6565,lon:-0.3903},{n:'St Albans',lat:51.7520,lon:-0.3390},
    {n:'Stevenage',lat:51.9022,lon:-0.2020},{n:'Bedford',lat:52.1364,lon:-0.4660},
    {n:'Solihull',lat:52.4118,lon:-1.7776},{n:'Dudley',lat:52.5123,lon:-2.0810},
    {n:'Walsall',lat:52.5860,lon:-1.9820},{n:'Crewe',lat:53.1000,lon:-2.4400},
    {n:'Chesterfield',lat:53.2350,lon:-1.4210},{n:'Mansfield',lat:53.1472,lon:-1.1980},
    {n:'Grimsby',lat:53.5670,lon:-0.0800},{n:'Scarborough',lat:54.2830,lon:-0.4000},
    {n:'Harrogate',lat:53.9921,lon:-1.5418},{n:'Darlington',lat:54.5270,lon:-1.5530},
    {n:'Gateshead',lat:54.9520,lon:-1.6040},{n:'Crawley',lat:51.1092,lon:-0.1872},
    {n:'Guildford',lat:51.2362,lon:-0.5704},{n:'Eastbourne',lat:50.7680,lon:0.2900},
    {n:'Hastings',lat:50.8543,lon:0.5735},{n:'Worthing',lat:50.8140,lon:-0.3710},
    {n:'Croydon',lat:51.3762,lon:-0.0982},{n:'Bromley',lat:51.4060,lon:0.0140},
    {n:'Greenwich',lat:51.4826,lon:-0.0077},{n:'Stratford',lat:51.5416,lon:-0.0030},
    {n:'Canary Wharf',lat:51.5054,lon:-0.0235},{n:'Westminster',lat:51.4975,lon:-0.1357},
    {n:'Camden',lat:51.5390,lon:-0.1426},{n:'Islington',lat:51.5465,lon:-0.1058},
    {n:'Hackney',lat:51.5450,lon:-0.0550},{n:'Southwark',lat:51.5035,lon:-0.0804},
    {n:'Brixton',lat:51.4613,lon:-0.1156},{n:'Clapham',lat:51.4619,lon:-0.1380},
    {n:'Wimbledon',lat:51.4214,lon:-0.2064},{n:'Richmond',lat:51.4613,lon:-0.3037},
    {n:'Ealing',lat:51.5130,lon:-0.3089},{n:'Heathrow',lat:51.4700,lon:-0.4543},
    {n:'Gatwick',lat:51.1537,lon:-0.1821},{n:'Stansted',lat:51.8850,lon:0.2350},
    {n:'Stanstead',lat:51.8850,lon:0.2350}
  ];
  ...
  function scorePlace(query, name) {
    var q = normStr(query), n = normStr(name);
    if (!q || !n) return 0;
    if (n === q) return 1000;
    if (n.indexOf(q) === 0) return 900 - Math.min(n.length, 50);
    if (n.indexOf(q) !== -1) return 700 - Math.min(n.indexOf(q), 40);
    var words = n.split(' ');
    for (var i = 0; i < words.length; i++) if (words[i].indexOf(q) === 0) return 800 - i * 10;
    var maxEd = q.length <= 3 ? 1 : (q.length <= 6 ? 2 : 3);
    var ed = editDist(q, n);
    if (ed <= maxEd) return 500 - ed * 40;
    if (words[0]) {
      var edw = editDist(q, words[0]);
      if (edw <= maxEd) return 480 - edw * 40;
    }
    if (q.length >= 3 && n.length >= q.length) {
      var edp = editDist(q, n.slice(0, q.length));
      if (edp <= 1) return 600 - edp * 30;
      if (n.indexOf(q.slice(0, Math.max(3, q.length - 1))) === 0) return 550;
    }
    return 0;
  }
  ...
  function localSuggestions(q) {
    ...
    for (var i = 0; i < UK_PLACES.length; i++) {
      var sc = scorePlace(q, UK_PLACES[i].n);
      if (sc > 0) scored.push({ score: sc, place: UK_PLACES[i] });
    }
    scored.sort(function (a, b) { return b.score - a.score; });
    var out = [], seen = {};
    for (var k = 0; k < scored.length && out.length < 6; k++) {
      var key = normStr(scored[k].place.n);
      if (seen[key]) continue;
      seen[key] = true;
      out.push({
        display_name: scored[k].place.n + ', United Kingdom',
        lat: String(scored[k].place.lat),
        lon: String(scored[k].place.lon),
        _local: true
      });
    }
    return out;
  ...
  async function fetchSuggestions(q) {
    ...
    if (local.length) showSuggest(local);
    if (typeof navigator !== 'undefined' && navigator.onLine === false) {
      if (!local.length) toast('No signal \u2014 connect to search');
      return;
    }
    try {
      ...
      var res = await fetch(url, { headers: { 'Accept-Language': 'en', 'User-Agent': 'GotToGo/3.2' } });
      if (!res.ok) throw new Error('HTTP ' + res.status);
      var data = await res.json();
      if (lastSuggestQ !== q) return;
      var merged = [], seen = {};
      function add(it) {
        var key = normStr((it.display_name || '').split(',')[0]);
      ...
      local.forEach(add);
      (data || []).forEach(add);
      if (!merged.length) { if (!local.length) hideSuggest(); return; }
  ...
  async function searchPlace(q) {
    ...
    if (typeof navigator !== 'undefined' && navigator.onLine === false) {
      var local = localSuggestions(q);
      if (local.length === 1) { await pickPlace(local[0]); return; }
      if (local.length > 1) { showSuggest(local); toast('Pick a place from the list'); return; }
      toast('No signal \u2014 connect to search');
      return;
    }
    toast('Searching\u2026');
    try {
      var local2 = localSuggestions(q);
      ...
      local2.forEach(add2);
      (data || []).forEach(add2);
      if (!merged.length) { toast('No place found in the UK'); hideSuggest(); return; }
      if (merged.length === 1) await pickPlace(merged[0]);
      else { showSuggest(merged); toast('Pick a place from the list'); }
  ...
  searchInput.addEventListener('input', function () {
    ...
    suggestTimer = setTimeout(function () { fetchSuggestions(q); }, 180);
  });
  searchInput.addEventListener('blur', function () { setTimeout(hideSuggest, 180); });
  ...
  window.addEventListener('online', function () {
    ...
    if (failedSplash) { setTimeout(function () { location.reload(); }, 600); return; }
    if (state.map) refreshNearby().catch(function () {});
  });
